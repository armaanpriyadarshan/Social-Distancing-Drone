# USAGE
# python social_distance_raspi_video.py --model MobileNetSSD_deploy.caffemodel --prototxt MobileNetSSD_deploy.prototxt --ip <IP ADDRESS> --port 8000
...
cap = cv2.VideoCapture('/home/pi/openvino-pi-object-detection/pedestrians.mp4')
time.sleep(2.0)
fps = FPS().start()
app = Flask(__name__)
